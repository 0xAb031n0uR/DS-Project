...
gost::gost(sf::RenderWindow& window, string s, int x, int y, int spd) {
	...
	gs.setPosition(sf::Vector2f(x, y));
	speed = spd;


}
void gost::BFS(int x_position, int y_position, int t_x, int t_y, int maze_arr[21][25])
{
